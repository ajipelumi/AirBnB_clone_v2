...
class HBNBCommand(cmd.Cmd):
    ...
    def do_create(self, args):
        ...
        c_name = new[0]
        c_arg = new[2]
        if not c_name:  # No arguments passed
        ...
        if c_arg is not None and c_arg != '':
            ...
            c_arg = c_arg.split(' ')  # Split command arg
            ...
            for item in c_arg:
                ...
                item = item.split('=')
                key = item[0]
                value = eval(item[1])  # Strip quotation marks from string
